// <copyright file="DocumentInformationExtractionRequest.cs" company="ITANEO">
...
public abstract partial record DocumentInformationExtractionRequest([property: DataMember(Order = 1)] string Id)
{
    /// <summary>
