// <copyright file="DocumentContainerRequest.cs" company="ITANEO">
...
public abstract partial record DocumentContainerRequest([property: DataMember(Order = 1)] string Id)
{
    /// <summary>
