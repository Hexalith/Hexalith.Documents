// <copyright file="DocumentSnapshotOnSummaryProjectionHandler.cs" company="ITANEO">
...
public class DocumentSnapshotOnSummaryProjectionHandler(IProjectionFactory<DocumentSummaryViewModel> factory)
