// <copyright file="DocumentInformationExtractionDetailsSnapshotHandler.cs" company="ITANEO">
...
/// </summary>
/// <param name="factory">The projection factory for document information extraction details view models.</param>
