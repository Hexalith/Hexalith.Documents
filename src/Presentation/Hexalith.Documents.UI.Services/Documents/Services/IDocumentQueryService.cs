...
public interface IDocumentQueryService : IIdDescriptionService
{
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains the document details as a <see cref="DocumentDetailsViewModel"/> object.</returns>
    ...
    /// </remarks>
    Task<DocumentDetailsViewModel> GetDetailsAsync(string id);

    /// <summary>
    /// Retrieves summaries for all documents in the system.
    /// </summary>
    /// <returns>A task that represents the asynchronous operation. The task result contains a collection of <see cref="DocumentSummaryViewModel"/> objects.</returns>
    /// <remarks>
    ...
    /// </remarks>
    Task<IEnumerable<DocumentSummaryViewModel>> GetSummariesAsync()
    ...
    /// </remarks>
    Task<IEnumerable<DocumentSummaryViewModel>> GetSummariesAsync(int skip, int count);
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains a collection of matching <see cref="DocumentSummaryViewModel"/> objects.</returns>
    ...
    /// </remarks>
    Task<IEnumerable<DocumentSummaryViewModel>> SearchSummariesAsync(string searchText);
}