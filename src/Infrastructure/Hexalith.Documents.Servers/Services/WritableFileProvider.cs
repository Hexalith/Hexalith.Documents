...
public class WritableFileProvider : IWritableFileProvider, IReadableFileProvider
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return storageType switch
        {
            ...
            DocumentStorageType.FileSystem => await _serviceProvider.GetRequiredService<FileSystemStorage>().CreateFileAsync(connectionString, path, fileName, tags, cancellationToken).ConfigureAwait(false),
