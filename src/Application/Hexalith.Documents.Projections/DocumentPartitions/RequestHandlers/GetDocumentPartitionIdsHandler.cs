...
/// </summary>
public class GetDocumentPartitionIdsHandler : RequestHandlerBase<GetDocumentPartitionIds>
{
    private readonly IIdCollectionFactory _factory;

    /// <summary>
    /// Initializes a new instance of the <see cref="GetDocumentPartitionIdsHandler"/> class.
    /// </summary>
    /// <param name="factory">The factory to create ID collection services.</param>
    public GetDocumentPartitionIdsHandler(IIdCollectionFactory factory)
    {
    ...
    public override async Task<GetDocumentPartitionIds> ExecuteAsync(GetDocumentPartitionIds request, Metadata metadata, CancellationToken cancellationToken)
    {
