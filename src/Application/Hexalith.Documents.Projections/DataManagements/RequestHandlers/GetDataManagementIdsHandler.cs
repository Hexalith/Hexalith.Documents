...
/// </summary>
public class GetDataManagementIdsHandler : RequestHandlerBase<GetDataManagementIds>
{
    private readonly IIdCollectionFactory _factory;

    /// <summary>
    /// Initializes a new instance of the <see cref="GetDataManagementIdsHandler"/> class.
    /// </summary>
    /// <param name="factory">The factory to create ID collection services.</param>
    public GetDataManagementIdsHandler(IIdCollectionFactory factory)
    {
    ...
    public override async Task<GetDataManagementIds> ExecuteAsync(GetDataManagementIds request, Metadata metadata, CancellationToken cancellationToken)
    {
