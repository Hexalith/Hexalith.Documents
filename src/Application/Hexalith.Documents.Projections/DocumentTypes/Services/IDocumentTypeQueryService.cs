...
public interface IDocumentTypeQueryService : IIdDescriptionService
{
    ...
    Task<DocumentTypeDetailsViewModel> GetDetailsAsync(ClaimsPrincipal user, string id, CancellationToken cancellationToken);
    ...
    /// </remarks>
    Task<IEnumerable<DocumentTypeSummaryViewModel>> GetSummariesAsync(ClaimsPrincipal user, CancellationToken cancellationToken)
    ...
    /// </remarks>
    Task<IEnumerable<DocumentTypeSummaryViewModel>> GetSummariesAsync(ClaimsPrincipal user, int skip, int take, CancellationToken cancellationToken);
    ...
    /// </remarks>
    Task<IEnumerable<DocumentTypeSummaryViewModel>> SearchSummariesAsync(ClaimsPrincipal user, string searchText, CancellationToken cancellationToken);
}