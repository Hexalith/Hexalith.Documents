...
public partial record GetDocumentContainerSummaries(
    ...
    [property: DataMember(Order = 5)] IEnumerable<DocumentContainerSummaryViewModel> Results) : IFilteredChunkableRequest
{
    /// <summary>
    ...
    public GetDocumentContainerSummaries(int skip, int take, string? filter = null)
        : this(skip, take, filter, Array.Empty<string>(), Array.Empty<DocumentContainerSummaryViewModel>())
    {
    }
