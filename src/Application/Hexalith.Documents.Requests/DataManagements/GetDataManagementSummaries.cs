...
public partial record GetDataManagementSummaries(
    ...
    [property: DataMember(Order = 5)] IEnumerable<DataManagementSummaryViewModel> Results) : IFilteredChunkableRequest
{
    /// <summary>
    ...
    public GetDataManagementSummaries(int skip, int take, string? filter = null)
        : this(skip, take, filter, Array.Empty<string>(), Array.Empty<DataManagementSummaryViewModel>())
    {
    }
